...
HOST = os.environ.get("FLUX_DASHBOARD_HOST", os.environ.get("DASHBOARD_HOST", os.environ.get("WORKER_HOST", "127.0.0.1")))
PORT = int(os.environ.get("FLUX_DASHBOARD_PORT", os.environ.get("DASHBOARD_PORT", os.environ.get("WORKER_PORT", "9000"))))
...
<head>
  <meta charset="utf-8">
  <title>Flux2 Water Meter Production</title>
  <style>
...
<body>
  <h1>Flux2 Water Meter Production</h1>
  <div class="grid">
